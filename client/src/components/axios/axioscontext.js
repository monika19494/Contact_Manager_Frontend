...
export const  Provider = (props) => {
  ...
  const userSignIn = (loginData) => {
    axios
      .post("https://contact-manager-backend-dpj4.onrender.com/login", loginData)
      .then((res) => {
  ...
  const postcontacts = async (contactdata) => {
    ...
    return await axios
      .post("https://contact-manager-backend-dpj4.onrender.com/api/v1/contacts",contactdata,config)
  ...
  const fetchContacts = () => {
    axios
      .get("https://contact-manager-backend-dpj4.onrender.com/api/v1/contacts",config)
      .then((res) => {
...
//delete contacts------------------------------------------------
  const deletecontacts=(id)=>{
    axios
      .delete(`https://contact-manager-backend-dpj4.onrender.com/api/v1/contacts/${id}`,config)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => console.log(err))
